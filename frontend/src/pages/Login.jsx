    ...
    <div className="min-h-screen flex">
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          ...
          <p className="mt-2 text-center text-sm">
            <Link to="/" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">&larr; Back to Home</Link>
          </p>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-600 to-primary-900 items-center justify-center p-12">
        <div className="text-white">
          <h2 className="text-4xl font-bold mb-4">CSR & ESG Impact Platform</h2>
          <p className="text-lg text-primary-200">Track, measure, and showcase your corporate social responsibility impact with transparency and precision.</p>
        </div>
      </div>
    </div>
  );
